  ...
  <div class="app">
    <aside class="sidebar">
      ...
      <div class="nav">
        ...
        <!-- Quản lý Sản phẩm -->
        <div class="navgrp">
          <div class="navgrp-header" @click="toggleSection('quanlysp')">
            <h4>Quản lý sản phẩm</h4>
            <ChevronDown :class="['chevron', { open: openSections.quanlysp }]" :size="18" />
          </div>
          
          <transition name="dropdown">
            <div v-show="openSections.quanlysp" class="navgrp-content">
              ...
              <RouterLink to="/admin/san-pham/chi-tiet/list">
                <span class="left">
                  <Layers class="icon" /> Biến thể sản phẩm
                </span>
              </RouterLink>
            </div>
          </transition>
