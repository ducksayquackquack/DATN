...
const routes = [
...

  {
    ...
    children: [
...

      {
        ...
        name: "employee-hoa-don-list",
      },
      {
        path: "hoa-don/detail/:id",
        component: HoaDonDetail,
        name: "employee-hoa-don-detail",
      },

      {
        path: "san-pham/list",
        component: AdminProductList,
        name: "employee-san-pham-list",
      },
      {
        path: "san-pham/form",
        component: AdminProductForm,
        name: "employee-san-pham-form",
      },

      {
        path: "khuyen-mai/list",
        component: KhuyenMaiList,
        name: "employee-khuyen-mai-list",
      },
      {
        path: "khuyen-mai/form",
        component: KhuyenMaiForm,
        name: "employee-khuyen-mai-form",
      },
      {
        path: "khuyen-mai/form/:id",
        component: KhuyenMaiForm,
        name: "employee-khuyen-mai-form-edit",
      },
    ],
  },

  {
    ...
    children: [
      ...
      {
        path: "phuong-thuc-thanh-toan/list",
        component: PhuongThucThanhToanList,
      },
      {
        path: "phuong-thuc-thanh-toan/form",
        component: PhuongThucThanhToanForm,
      },
      {
        path: "phuong-thuc-thanh-toan/form/:id",
        component: PhuongThucThanhToanForm,
      },
