...
public class HoaDonController {
    ...
    public HoaDonController(HoaDonRepsitory hoaDonRepsitory, NhanVienRepository nhanVienRepository, KhachHangRepository khachHangRepository) {
